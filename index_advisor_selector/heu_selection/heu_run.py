...
from index_eab.eab_algo.heu_selection.heu_utils.selec_com import get_parser
from index_eab.eab_algo.heu_selection.heu_utils.postgres_dbms import PostgresDatabaseConnector

from index_eab.eab_algo.heu_selection.heu_algos.auto_admin_algorithm import AutoAdminAlgorithm
from index_eab.eab_algo.heu_selection.heu_algos.db2advis_algorithm import DB2AdvisAlgorithm, IndexBenefit
...
from index_eab.eab_algo.heu_selection.heu_algos.cophy_algorithm import CoPhyAlgorithm
...
def get_heu_result(args, algos, work_list):
    ...
    _, columns = selec_com.get_columns_from_schema(args.schema_file)
    ...
    for algo in tqdm(algos):
        ...
        workload = Workload(selec_com.read_row_query(work_list, exp_config, columns, type="",
