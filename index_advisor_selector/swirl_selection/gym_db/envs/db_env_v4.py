...
from swirl_selection.gym_db.common import EnvironmentType
from swirl_selection.swirl_utils.swirl_com import b_to_mb
...
class DBEnvV4(gym.Env):
    ...
    def _report_episode_performance(self, environment_state):
        ...
        output = (
            ...
            f"Indexes: {self.current_indexes}\n    "
        )
